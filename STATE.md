...
- **В процессе:** Применение индексов в Supabase + load test + метрики.
- **Очередь:** Phase 2-3 — API endpoints migration, WebSocket integration, Railway deployment, gradual rollout на 100%.
