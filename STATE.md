...
### 2026-05-03 — AdIntakeBot: /start — только RU + «в vformate» + шаблоны

- **`buildStartWelcomeBody`:** «—», затем «Здравствуйте, эта компания в vformate.» + три строки + «Шаблоны: /templates»; казахский блок убран.
