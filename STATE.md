...
- **`assets/vformate-logo.png`:** при `/start` в личке клиенту отправляется фото с подписью «vformate — рекламное агентство» (kk/ru/en); fallback — только текст, если файла нет.
