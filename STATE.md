...
- **relay‑лог менеджера:** в историю диалога пишется маркер и для нетекстовых ответов менеджера (`[manager relay voice/photo/document]`), чтобы thread не обрывался в хронологии.
