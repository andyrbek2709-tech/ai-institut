...
КЛЮЧЕВОЕ ПРАВИЛО: НЕ задавай уточняющих вопросов до того как вызвал search_normativka. Сначала вызови инструмент с тем что есть, посмотри что вернётся, потом если контекст недостаточен — уточняй. Лучше дать частичный ответ из найденного, чем спрашивать без поиска.`,
