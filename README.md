...
### Фаза 1 — UX-улучшения (быстрые победы) `~2 недели`

| ID | Фича | Описание | Приоритет |
|----|------|----------|-----------|
| **D3** | Центр уведомлений | Колокольчик в шапке — лента всех событий: новые задачи, смены статусов, замечания | 🔴 Высокий |
| **D4** | Drag & Drop Kanban | Перетаскивание карточек задач мышью между статусами (react-dnd или @dnd-kit) | 🔴 Высокий |
| **D5** | Timeline-вид проекта | Горизонтальная лента с вехами, дедлайнами и % выполнения по фазам | 🟡 Средний |
| **D6** | Аватары с фото | Загрузка фото профиля в Supabase Storage, fallback на инициалы | 🟢 Низкий |
| **E1** | Треды замечаний | Переписка внутри замечания с историей ответов (дерево комментариев) | 🟡 Средний |
| **E2** | Трекер статуса чертежа | Визуальный pipeline: черновик → проверка → согласовано → выпущено | 🟡 Средний |
| **R4** | Шаблоны задач | Библиотека типовых задач по дисциплинам (КЖ, КМ, ОВ, ВК, ЭО…) — создание одним кликом | 🟡 Средний |
| **T5** | Версионирование данных | История изменений задач и чертежей, diff, возможность отката | 🟡 Средний |
...
| 1 | D5 | Timeline-вид проекта | 🟡 | ⏳ |
| 1 | D6 | Аватары с фото | 🟢 | ⏳ |
| 1 | E1 | Треды замечаний | 🟡 | ⏳ |
| 1 | E2 | Трекер статуса чертежа | 🟡 | ⏳ |
| 1 | R4 | Шаблоны задач | 🟡 | ⏳ |
| 1 | T5 | Версионирование данных | 🟡 | ⏳ |
| 2 | A1 | AI-анализ чертежей | 🔴 | ⏳ |
| 2 | A2 | Risk AI — прогноз рисков | 🔴 | ⏳ |
| 2 | A3 | AI-планировщик задач | 🔴 | ⏳ |
| 2 | A4 | Умный поиск (NL) | 🔴 | ⏳ |
| 2 | A5 | AI-транскрипция совещаний | 🟡 | ⏳ |
| 2 | A6 | AI-помощник в формах | 🟡 | ⏳ |
| 2 | A7 | Еженедельный AI-дайджест | 🔴 | ⏳ |
| 2 | A8 | AI-нормоконтролёр | 🔴 | ⏳ |
| 3 | E3 | Telegram-бот | 🔴 | ⏳ |
