 ...
 * «В формате» — один раз в приветствии (название-игра слов), без дубля vformate в скобках.
 */
export function buildStartWelcomeBody() {
  return [
    "👋 Сәлеметсіз бе, бұл компания в формате.",
    ...
    "—",
    "",
    "👋 Здравствуйте, эта компания в формате.",
