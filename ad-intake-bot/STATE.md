...
## 2026-05-03 — /start: лого + kk/ru

- Фото (предпочтительно `vformate-logo-telegram.png`) + короткая подпись, затем kk+ru: «Сәлеметсіз бе, бұл компания в формате.» / «Здравствуйте, эта компания в формате.» без дубля имени в скобках.
